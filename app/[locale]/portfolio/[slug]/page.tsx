        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="space-y-8">
            ...
            <div className="flex gap-8 text-sm text-muted-foreground border-y border-border/50 py-6">
              <div>
                <p className="font-bold text-foreground mb-1 uppercase tracking-wider text-xs">Date</p>
                <p>{project.date}</p>
              </div>
          ...
          <div className="relative aspect-[3/4] rounded-3xl overflow-hidden bg-secondary shadow-2xl">
            {project.src.startsWith("bg-") ? (
              <div className={`w-full h-full ${project.src} flex items-center justify-center text-muted-foreground`}>
