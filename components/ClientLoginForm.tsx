        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-secondary px-6 py-2 rounded-full flex items-center gap-2 border border-border">
              <Heart size={18} className={favorites.length > 0 ? "fill-primary text-primary" : ""} />
            ...
            {MOCK_CLIENT_GALLERY.map((item) => (
              <div key={item.id} className="relative group">
                ...
                <button 
                  ...
                  aria-label={favorites.includes(item.id) ? "Remove from selection" : "Add to selection"}
          ...
          {favorites.length > 0 && (
            ...
            >
              <p className="text-sm font-medium">
                You have selected <span className="font-bold">{favorites.length}</span> photos for retouching
              </p>
