  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <main className="flex-1 flex flex-col">
        ...
        <section
          ref={targetRef}
          className="relative py-32 md:py-48 flex flex-col items-center justify-center min-h-[95vh]"
        >
          <motion.div
            initial="hidden"
            animate="show"
          ...
          >
            ...
            >
              <Link href="/portfolio">
                <Button variant="editorial" size="lg" className="h-16 px-12">
                  {t('viewPortfolio')}
                </Button>
              </Link>
              <Link href="/contact">
          ...
          >
            <span className="text-[8px] font-bold tracking-[0.4em] text-foreground/20 uppercase">
              Scroll to explore
            </span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center max-w-7xl mx-auto">
              ...
              >
                <motion.span
                  ...
                  className="text-[10px] font-bold text-foreground/40 uppercase tracking-[0.4em] mb-8 block"
                >
                  {t('aboutSection.title')}
                </motion.span>
                <motion.h2
                  variants={fadeInVariants}
                  className="text-6xl md:text-8xl font-bold mb-12 leading-[0.85] tracking-tighter uppercase"
                >
                  Pure <br /> Aesthetics
                </motion.h2>
                <motion.p
                  variants={fadeInVariants}
                  className="text-lg text-muted-foreground mb-14 leading-relaxed font-medium max-w-md"
                >
                ...
                <motion.div variants={fadeInVariants}>
                  <Link
                    href="/about"
                    className="text-[10px] font-bold uppercase tracking-[0.3em] border-b border-foreground pb-2 hover:opacity-50 transition-opacity"
                  >
                    {t('aboutSection.link')}
                  </Link>
                </motion.div>
